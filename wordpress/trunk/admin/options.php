...
<tr>
<th scope="row"><label for="google_analytics_tracking_id"><?php _e( 'Tracking ID', 'mpcx-googleanalytics' ); ?>:</label></th>
...
<tr>
<th scope="row"><label for="google_analytics_opt_out"><?php _e( 'User Opt-out', 'mpcx-googleanalytics' ); ?>:</label></th>
